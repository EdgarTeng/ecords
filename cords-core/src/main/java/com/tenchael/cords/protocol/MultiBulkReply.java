...
import static com.tenchael.cords.netty.CordsCommandDecoder.readLong;
import static com.tenchael.cords.utils.Encoding.NEG_ONE_WITH_CRLF;
...
public class MultiBulkReply implements Reply<Reply[]> {
    ...
    public void read(CordsCommandDecoder rd, ByteBuf is) throws IOException {
        if (size == -2) {
            long l = readLong(is);
